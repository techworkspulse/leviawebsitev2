    ...
    return(
        <>
            ...
            <Image src="/img/big-star.svg" className="w-[20%] absolute left-[-12%] mx-auto bottom-[14.5%] 3xl:bottom-[19.5%] z-[2]" alt="Facebook" width="500" height="500"/>
                ...
                <motion.div 
                    className="w-full lg:w-[80%] xl:w-[70%] md:gap-1 hidden lg:flex flex-wrap justify-center m-auto relative"
                    variants={variants}
                    initial="hidden"
                    whileInView="show"
                >
                    <motion.div 
                        className="group h-[400px] w-[400px] 3xl:h-[450px] 3xl:w-[450px] [perspective:1000px]"
                        variants={paragraf}
                    >
                    ...
                    <Image src="/img/features/star-middle-01.png" width="1229" height="464" alt="Star middle" className="absolute top-[37.5%] left-[17.5%] 3xl:top-[39%] 3xl:left-[23.8%] w-[545px] h-auto" />
                </motion.div>
