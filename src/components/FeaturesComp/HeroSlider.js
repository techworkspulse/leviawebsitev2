        ...
        <Slider {...settings} className="heroslider">
              ...
              <div className="relative">
                ...
                <div className="text-center py-8 w-[85%] lg:w-[70%] xl:w-[60%] mx-auto">
                  ...
                  <p className="font-GothamBook text-white leading-normal lg:leading-loose text-[15px] sm:text-[17px] md:text-[18px] lg:text-[17px] xl:text-[17px] 2xl:text-[18px] 3xl:text-[20px]">Enjoy an exclusive, elegant five-star reception in a lobby designed with refined décor and furnishing with accessible, cosy layouts for life, work and play.</p>
                </div>
              </div>
        </Slider>
      </div>
