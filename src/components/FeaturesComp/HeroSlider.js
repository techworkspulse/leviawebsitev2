      ...
      <div>
        <Slider {...settings} className="heroslider">
              ...
              >
                ...
                <Image src="/img/star-line-full.svg" className="hidden lg:block w-[30%] 2xl:w-[40%] absolute left-0 right-0 mx-auto bottom-[26.5%] lg:bottom-[27.5%] xl:bottom-[26.8%] cxl:bottom-[26.5%] 3xl:bottom-[26.5%]" alt="Star full features" width="1920" height="1000"/>
                <motion.div 
