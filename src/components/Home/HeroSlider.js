        ...
        <Slider {...settings}>
              <div className="relative">
                ...
                <div className="text-center py-8 xl:w-[60%] mx-auto">
                  ...
                  <p className="font-GothamBook tex-white leading-loose text-[17px] md:text-[18px] lg:text-[18px] 2xl:text-[18px] 3xl:text-[20px]">Celebrate dynamic excellence in life within the dazzling towers of LEVIA, a new vertical residence that integrates
