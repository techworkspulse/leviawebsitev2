...
const Navmenu = () => {
    return(
        <>
        <nav className="hidden md:block md:p-0 fixed h-[100px] w-full bg-[#0000006e] to-opacity-50 border-gray-200 z-[100] shadow-sm">
            <div className="flex justify-center items-center h-full">
                ...
                <Link className="font-GothamBook uppercase tracking-wider text-[20px] md:text-[14px] 3xl:text-[16px] mr-7" href="/">Features</Link>
