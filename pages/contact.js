                ...
                <div className="container w-[90%] sm:w-[85%] mx-auto">
                    ...
                    <div className="w-full xl:w-[90%] 2xl:w-[85%] mx-auto flex flex-col sm:flex-row items-center mt-8 lg:mt-14">
                        ...
                        <div className="text-center sm:text-left">
                            <p className="font-Avgardn text-[#bda37f] leading-7 tracking-[1px] text-[15px] sm:text-[17px] md:text-[18px] lg:text-[17px] xl:text-[17px] 2xl:text-[18px] 3xl:text-[20px]">Head Office<br></br>Wisma Matrix, No.57, Jalan Tun Dr. Ismail,<br></br>70200 Seremban, Negeri Sembilan D.K. Malaysia</p>
                    ...
                    <div className="w-full xl:w-[90%] 2xl:w-[85%] mx-auto mt-8 lg:mt-14">
                        <div className="flex flex-col lg:flex-row items-center justify-between">
                            <div className="flex flex-col sm:flex-row items-center flex-1 w-full lg:w-fit border-none lg:border-solid border border-[#bda37f] border-b-0 border-t-0 border-l-0 pr-0 lg:pr-5">
                                ...
                                <div className="text-center sm:text-left">
                                    <p className="font-Avgardn text-[#bda37f] leading-7 tracking-[1px] text-[15px] sm:text-[17px] md:text-[18px] lg:text-[17px] xl:text-[17px] 2xl:text-[18px] 3xl:text-[20px]">Branch Office<br></br>A-1-5, Block A, Setiawalk, Persiaran Wawasan,<br></br>
