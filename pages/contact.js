            ...
            <section className="pt-0">
                <div className="container w-[90%] sm:w-[85%]  mx-auto">
                    ...
                    <div className="w-fulll xl:w-[80%] mx-auto flex flex-wrap items-center justify-center pt-8 mt-8">
                        <img src="/img/awards/award1.svg" className="max-h-[120px] w-[48%] sm:w-[28%] lg:w-[15%] object-contain mb-8 mb-lg-0"></img>
                        <img src="/img/awards/award2.svg" className="max-h-[120px] w-[48%] sm:w-[28%] lg:w-[15%] object-contain mb-8 mb-lg-0"></img>
                        <img src="/img/awards/award3.svg" className="max-h-[120px] w-[48%] sm:w-[28%] lg:w-[15%] object-contain mb-8 mb-lg-0"></img>
                        <img src="/img/awards/award4.svg" className="max-h-[120px] w-[48%] sm:w-[28%] lg:w-[15%] object-contain mb-8 mb-sm-0"></img>
                        <img src="/img/awards/award5.svg" className="max-h-[120px] w-[48%] sm:w-[28%] lg:w-[15%] object-contain mb-8 mb-sm-0"></img>
                        <img src="/img/awards/award6.svg" className="max-h-[120px] w-[48%] sm:w-[28%] lg:w-[15%] object-contain mb-8 mb-sm-0"></img>
                    </div>
